...
public class TowerToolTip extends CustomToolTip {
    ...
    public TowerToolTip(TowerType t){
        ...
        */
        ...
        dataArray[1][1] = new Label(String.valueOf(t.getRange()), Label.SMALL);

        dataArray[2][0] = new Label("Cost ", Label.SMALL_BOLD_FONT);
        dataArray[2][1] = new Label(String.valueOf(t.getCost()), Label.SMALL);

        dataArray[3][0] = new Label("Rate ", Label.SMALL_BOLD_FONT);
        dataArray[3][1] = new Label(String.valueOf(t.getFireRate()), Label.SMALL);

        dataArray[4][0] = new Label("Dmg ", Label.SMALL_BOLD_FONT);
        dataArray[4][1] = new Label(String.valueOf(t.getDmg()), Label.SMALL);
